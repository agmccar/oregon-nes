...
;  |||||||+----- trail divides(?) TODO
;  |||||++------ unused
;  ||+++-------- river ID- 0:kansas, 1:big blue, 2:green, 3:snake
;  ||            fort ID- 0:independence, 1:kearney, 2:laramie, etc.
;  |+----------- river- y/n
;  +------------ store (fort)- y/n
landmarkAttr:
    .byte %10000000 ; Independence, MO
    .byte %01000000 ; KANSAS RIVER CROSSING
    .byte %01001000 ; BIG BLUE RIVER CROSSING
    .byte %10001000 ; FORT KEARNEY
    .byte %00000000 ; CHIMNEY ROCK
    .byte %10010000 ; FORT LARAMIE
    .byte %00000000 ; INDEPENDENCE ROCK
    .byte %00000000 ; SOUTH PASS
    .byte %10011000 ; FORT BRIDGER
    .byte %01010000 ; GREEN RIVER CROSSING
    .byte %00000000 ; SODA SPRINGS
    .byte %10100000 ; FORT HALL
    .byte %01011000 ; SNAKE RIVER CROSSING
    .byte %10101000 ; FORT BOISE
    .byte %00000000 ; BLUE MOUNTAINS
    .byte %10110000 ; FORT WALLA WALLA
