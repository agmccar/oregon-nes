...
EVENT_NONE = 0
EVENT_NEXT_LANDMARK = 1 ; "It is xxx miles to yyyy" popup
EVENT_INDIAN_FOOD = 2
EVENT_THUNDERSTORM = 3
EVENT_BLIZZARD = 4
EVENT_HEAVY_FOG = 5
EVENT_HAIL_STORM = 6
EVENT_INJURED_OX = 7
EVENT_INJURED_PERSON = 8
EVENT_SNAKE_BITE = 9
EVENT_LOSE_TRAIL = 10
EVENT_WRONG_TRAIL = 11
EVENT_ROUGH_TRAIL = 12
EVENT_IMPASSIBLE_TRAIL = 13
EVENT_WILD_FRUIT = 14
EVENT_FIRE_WAGON = 15
EVENT_LOST_PERSON = 16
EVENT_OX_WANDERS_OFF = 17
EVENT_ABANDONED_WAGON = 18
EVENT_THIEF = 19
EVENT_BAD_WATER = 20
EVENT_LITTLE_WATER = 21
EVENT_INADEQUATE_GRASS = 22
EVENT_ILLNESS = 23
EVENT_BROKEN_PART = 24
