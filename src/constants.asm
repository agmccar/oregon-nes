...
; other tiles
TILE_GRASS = $ff
TILE_DARK_SQ = $1c ; dark square (adornment)
TILE_LIGHT_SQ = $1d ; light square (adornment)
TILE_COL_HEADER = $48 ; hack to improve some column headers' readability
TILE_GREEN_LINE = $49 ; green line in Matt's General Store
...
GAMESTATE_RIVER     = 6 ; river crossing
GAMESTATE_HUNTING   = 7 ; hunting minigame
...
; .%%..%%...%%%%...%%...%%..........%%%%%...%%..%%..%%..%%..%%..%%.
; .................................................................
; Which ROM bank contains code and data for each game state
BANK_TITLE = 0
BANK_NEWGAME = 1
BANK_STORE = 1
BANK_LANDMARK = 6
...
MENU_MATT_LOADING = 37
MENU_PACE_HELP = 38
MENU_RIVER_INTRO = 39
MENU_RIVER_OPTIONS = 40
MENU_RIVER_HELP = 41
MENU_RIVER_WAIT = 42
MENU_RIVER_FERRY = 43
MENU_RIVER_INDIAN = 44
MENU_RIVER_CROSSING = 45
; Traveling Main menu options
; todo deprecate
OPT_CONTINUE    = 0
OPT_SUPPLIES    = 1
OPT_MAP         = 2
